...
if (!empty($_POST['btn_submit'])) {
    ...
    if (empty($error_message)) {
        ...
        if ($mysqli->connect_errno) {
            ...
            // データを登録するSQL作成
            $sql = "INSERT INTO word (view_name, message, post_date) VALUES ( '$clean[view_name]', '$clean[message]', '$now_date')";
...
if ($mysqli->connect_errno) {
    ...
    $sql = "SELECT view_name,message,post_date FROM word ORDER BY post_date DESC";
    $res = $mysqli->query($sql);
